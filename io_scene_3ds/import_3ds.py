...
def add_texture_to_material(image, contextWrapper, pct, extend, alpha, scale, offset, angle, mapto):
    ...
    if mapto == 'COLOR':
        ...
        mixer.inputs[1].default_value = shader.inputs['Base Color'].default_value[:]
...
def process_next_chunk(context, file, previous_chunk, imported_objects, CONSTRAIN, FILTER,
    ...
    def read_texture(new_chunk, temp_chunk, name, mapto):
        ...
        contextWrapper.node_principled_bsdf.inputs[14].default_value = contextReflection
