...
### LATEST RELEASE (STABLE): v1.3.3

   1. From the [latest release](https://github.com/open-stage/blender-dmx/releases/latest) download the [blenderDMX_v1.3.3.zip](https://github.com/open-stage/blender-dmx/releases/download/v1.3.3/blenderDMX_v1.3.3.zip) file
